...
public partial class Simplex : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public Simplex() {
        this.Url = "http://localhost:25085/Simplex.asmx";
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetA(System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetA", new object[0], callback, asyncState);
    }
    
    /// <remarks/>
    public A EndGetA(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((A)(results[0]));
    }
